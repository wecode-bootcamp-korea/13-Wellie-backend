...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='book',
            name='author',
            field=models.ManyToManyField(related_name='author_books', through='book.BookToAuthor', to='book.Author'),
        ),
        migrations.AddField(
            model_name='book',
            name='publisher',
        ...
        migrations.AddField(
            model_name='book',
            name='tags',
            field=models.ManyToManyField(related_name='tag_books', through='book.BookToTag', to='book.Tag'),
        ),
        migrations.CreateModel(
            name='CommentLike',
            fields=[
